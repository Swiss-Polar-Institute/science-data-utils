...
class TestFerryboxBadDataTimesToStatus(unittest.TestCase):
    ...
    def test_collapse_same_day_off_one_consecutive(self):
        ...
        Test where there are two rows that should be combined into one row, but because they are consecutive rather than run over midnight and consecutive. """
        off_input = [[text_to_dt('2016-12-24 11:30:00'), text_to_dt('2016-12-24 12:30:00')],
    ...
    def test_combine_multiday_rows_join(self):
        ...
        off_input = [[text_to_dt('2016-12-24 11:30:00'), text_to_dt('2016-12-24 12:30:00'), 'off'],
